...
var bankManagerHelper = require('../helper/bankManagerHelper.js');
...
describe('Checking bank manager module functions', function () {
    ...
    fit('should be able to delete customer account successfully', function () {
        ...
        generalHelper.sendKeyAndSubmit(bankManagerPage.searchBar(), customerName, 'provide customername inside search bar');
        expect(generalHelper.isEnabledPromise(bankManagerPage.tableBody(), "Visibality of the deleted row")).toBe(false);
    });
